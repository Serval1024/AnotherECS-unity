...
namespace AnotherECS.Essentials.Physics
{
    ...
    public struct PhysicsWorld : ICollidable, IDisposable
    {
        ...
        public int GetRigidBodyIndex(EntityId entity) => CollisionWorld.GetRigidBodyIndex(entity);
        public int GetJointIndex(EntityId entity) => DynamicsWorld.GetJointIndex(entity);
